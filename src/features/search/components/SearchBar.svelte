...
>
  ...
  <input
    class="p-3 rounded-md flex-1 border-2 outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-300 placeholder:font-semibold placeholder:text-blue-400 font-semibold text-center sm:text-left"
    name="search-query"
    id="search-query"
    type="text"
